...
training = DkubeTraining("oc", name=training_name, description='triggered from dkube pl launcher')
...
res = launch_slurmjob("dap20", props, "oc", token, training.job, url="https://192.168.200.133:32222")
