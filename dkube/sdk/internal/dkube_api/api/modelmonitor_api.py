...
class ModelmonitorApi(object):
    ...
    def modelmonitor_archive(self, data, archive, **kwargs):  # noqa: E501
        """API to archive modelmonitor  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.modelmonitor_archive(data, archive, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.modelmonitor_archive_with_http_info(data, archive, **kwargs)  # noqa: E501
        else:
            (data) = self.modelmonitor_archive_with_http_info(data, archive, **kwargs)  # noqa: E501
            return data

    def modelmonitor_archive_with_http_info(self, data, archive, **kwargs):  # noqa: E501
        """API to archive modelmonitor  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.modelmonitor_archive_with_http_info(data, archive, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['data', 'archive']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('data' not in params or
                params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `modelmonitor_archive`")  # noqa: E501
