...
class DkubeApi(object):
    ...
    def featuresets_archive(self, archive, data, **kwargs):  # noqa: E501
        ...
        :param Data38 data: List of featuresets to archive (required)
        :return: ApiResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_inference_endpoints(self, **kwargs):  # noqa: E501
        """API to get inference endpoints.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_inference_endpoints(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_inference_endpoints_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_inference_endpoints_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_inference_endpoints_with_http_info(self, **kwargs):  # noqa: E501
        """API to get inference endpoints.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_inference_endpoints_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_inference_endpoints" % key
                )
            params[key] = val
        del params['kwargs']
