...
class DkubeApi(object):
    ...
    def cluster_login(self, data, **kwargs):  # noqa: E501
        """API to login to cluster.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_login(data, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.cluster_login_with_http_info(data, **kwargs)  # noqa: E501
        else:
            (data) = self.cluster_login_with_http_info(data, **kwargs)  # noqa: E501
            return data

    def cluster_login_with_http_info(self, data, **kwargs):  # noqa: E501
        """API to login to cluster.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_login_with_http_info(data, async_req=True)
        >>> result = thread.get()
        ...
        if ('data' not in params or
                params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `cluster_login`")  # noqa: E501
    ...
    def featuresets_archive(self, archive, data, **kwargs):  # noqa: E501
        ...
        :param Data42 data: List of featuresets to archive (required)
        :return: ApiResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_cluster_details_with_http_info(self, clustername, **kwargs):  # noqa: E501
        ...
        all_params = ['clustername', 'user']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def model_image_build(self, user, data, **kwargs):  # noqa: E501
        """API to build image with model  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.model_image_build(user, data, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.model_image_build_with_http_info(user, data, **kwargs)  # noqa: E501
        else:
            (data) = self.model_image_build_with_http_info(user, data, **kwargs)  # noqa: E501
            return data

    def model_image_build_with_http_info(self, user, data, **kwargs):  # noqa: E501
        """API to build image with model  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.model_image_build_with_http_info(user, data, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method model_image_build" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user' is set
        if ('user' not in params or
                params['user'] is None):
            raise ValueError("Missing the required parameter `user` when calling `model_image_build`")  # noqa: E501
        # verify the required parameter 'data' is set
        if ('data' not in params or
                params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `model_image_build`")  # noqa: E501
