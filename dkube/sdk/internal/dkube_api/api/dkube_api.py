...
class DkubeApi(object):
    ...
    def featureset_copy_version_status_with_http_info(self, body, featureset, version, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/featuresets/{featureset}/versions/{version}/copy_status', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def featuresets_archive(self, body, archive, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param Body79 body: List of featuresets to archive (required)
