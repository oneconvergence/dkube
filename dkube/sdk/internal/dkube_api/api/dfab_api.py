...
class DfabApi(object):
    ...
    def users_get_all(self, **kwargs):  # noqa: E501
        """API to get all the users.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_get_all(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.users_get_all_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.users_get_all_with_http_info(**kwargs)  # noqa: E501
            return data

    def users_get_all_with_http_info(self, **kwargs):  # noqa: E501
        """API to get all the users.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_get_all_with_http_info(async_req=True)
        >>> result = thread.get()
