...
class DfabApi(object):
    ...
    def groups_create_one_or_update(self, body, **kwargs):  # noqa: E501
        """API to create a new group if not present and update group with pools and users.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_create_one_or_update(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Body46 body: (required)
        :return: ApiResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.groups_create_one_or_update_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.groups_create_one_or_update_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def groups_create_one_or_update_with_http_info(self, body, **kwargs):  # noqa: E501
        """API to create a new group if not present and update group with pools and users.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_create_one_or_update_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `groups_create_one_or_update`")  # noqa: E501
    ...
    def groups_delete_list(self, body, **kwargs):  # noqa: E501
        """API to delete a list of groups  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_delete_list(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Body48 body: (required)
        :return: ApiResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.groups_delete_list_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.groups_delete_list_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def groups_delete_list_with_http_info(self, body, **kwargs):  # noqa: E501
        """API to delete a list of groups  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_delete_list_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `groups_delete_list`")  # noqa: E501
    ...
    def groups_get_collection_all_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['notonboarded']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        query_params = []
        if 'notonboarded' in params:
            query_params.append(('notonboarded', params['notonboarded']))  # noqa: E501
    ...
    def pools_create_one_or_update(self, body, **kwargs):  # noqa: E501
        """API to create a new pool if not present and update group with pools and users.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pools_create_one_or_update(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.pools_create_one_or_update_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.pools_create_one_or_update_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def pools_create_one_or_update_with_http_info(self, body, **kwargs):  # noqa: E501
        """API to create a new pool if not present and update group with pools and users.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pools_create_one_or_update_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `pools_create_one_or_update`")  # noqa: E501
    ...
    def pools_delete_list(self, body, **kwargs):  # noqa: E501
        """API to delete a list of pools  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pools_delete_list(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.pools_delete_list_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.pools_delete_list_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def pools_delete_list_with_http_info(self, body, **kwargs):  # noqa: E501
        """API to delete a list of pools  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pools_delete_list_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `pools_delete_list`")  # noqa: E501
