...
class ReportConfigurationDef(object):
    ...
    def __init__(self, name=None, id=None, long_term_frequency=None, short_term_frequency=None, title=None, emails=None, created_at=None, updated_at=None, enabled=None, long_term_report_exist=None, short_term_report_exist=None, status=None):  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this ReportConfigurationDef.  # noqa: E501


        :return: The status of this ReportConfigurationDef.  # noqa: E501
        :rtype: ReportingStatusDef
        """
        return self._status

    @status.setter
    def status(self, status):
        """Sets the status of this ReportConfigurationDef.


        :param status: The status of this ReportConfigurationDef.  # noqa: E501
        :type: ReportingStatusDef
        """
