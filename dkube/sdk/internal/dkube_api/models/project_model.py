...
class ProjectModel(object):
    ...
    def __init__(self, name=None, description=None, image=None, leaderboard=False, id=None, owner=None, group=None, last_updated=None, details=None, eval_repo=None, eval_commit_id=None, eval_image=None, eval_script=None, eval_details=None, submissions=None, status=None, eval_dataset=None):  # noqa: E501
