...
class DatumModel(object):
    ...
    def __init__(self, version=None, name=None, description=None, tags=None, _class=None, dvs=None, source=None, url=None, remote=False, gitaccess=None, redshift=None, s3access=None, k8svolume=None, hostpath=None, nfsaccess=None, gcsaccess=None, fsx=None, generated=None):  # noqa: E501
    ...
    def source(self, source):
        ...
        :type: str
        """
        allowed_values = ["git", "aws_s3", "s3", "pub_url", "k8s_volume", "dkube", "nfs", "gcs", "dvs", "workstation", "redshift", "hostpath", "fsx"]  # noqa: E501
