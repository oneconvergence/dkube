...
class InferenceJobModel(object):
    ...
    def __init__(self, model=None, version=None, owner=None, device=None, deploy=False, mcname=None, serving_image=None, transformer=False, transformer_image=None, transformer_project=None, transformer_commit_id=None, transformer_code=None, min_replicas=None, max_concurrent_requests=None, envs=None, resource_requirements=None, enable_logs=None, event_source=None, kafka_event_source=None, tags=None):  # noqa: E501
    ...
    @property
    def tags(self):
        """Gets the tags of this InferenceJobModel.  # noqa: E501

        Custom tags set by user for the job.  # noqa: E501

        :return: The tags of this InferenceJobModel.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this InferenceJobModel.

        Custom tags set by user for the job.  # noqa: E501

        :param tags: The tags of this InferenceJobModel.  # noqa: E501
        :type: list[str]
        """
