...
class InferenceJobModel(object):
    ...
    def __init__(self, model=None, version=None, owner=None, device=None, deploy=False, mcname=None, serving_image=None, transformer=False, transformer_image=None, transformer_project=None, transformer_commit_id=None, transformer_code=None, min_replicas=None, max_concurrent_requests=None, envs=None):  # noqa: E501
