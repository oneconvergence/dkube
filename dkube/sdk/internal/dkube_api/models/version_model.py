...
class VersionModel(object):
    ...
    def __init__(self, name=None, uuid=None, tags=None, description=None, index=None, timestamps=None, sync_state=None, storage_path=None, user=None, datum_name=None, datum_uuid=None, run_uuid=None, tracking_uuid=None, commit_id=None, size=None, datum_type=None, images=None, model=None):  # noqa: E501
