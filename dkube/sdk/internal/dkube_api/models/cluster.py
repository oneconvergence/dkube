...
class Cluster(object):
    ...
    def __init__(self, name=None, kind=None, url=None, ca=None, version=None, auth_type=None, jwt_signing_key=None, slurm_user=None, tags=None, description=None, plugin=None, login_required=False, token=None, login_form=None):  # noqa: E501
