...
class DevicePoolModel(object):
    ...
    attribute_map = {
        ...
        'name': 'name',
        '_class': 'class',
        'mig_ndevices': 'mig_ndevices',
        'ndevices': 'ndevices',
        'created_at': 'created_at',
        'generated': 'generated'
    }

    def __init__(self, version=None, name=None, _class=None, mig_ndevices=None, ndevices=None, created_at=None, generated=None):  # noqa: E501
        """DevicePoolModel - a model defined in Swagger"""  # noqa: E501

        self._version = None
        self._name = None
        self.__class = None
        self._mig_ndevices = None
        self._ndevices = None
        ...
        if _class is not None:
            self._class = _class
        if mig_ndevices is not None:
            self.mig_ndevices = mig_ndevices
    ...
    @property
    def mig_ndevices(self):
        """Gets the mig_ndevices of this DevicePoolModel.  # noqa: E501

        Number of mig devices in the pool  # noqa: E501

        :return: The mig_ndevices of this DevicePoolModel.  # noqa: E501
        :rtype: int
        """
        return self._mig_ndevices

    @mig_ndevices.setter
    def mig_ndevices(self, mig_ndevices):
        """Sets the mig_ndevices of this DevicePoolModel.

        Number of mig devices in the pool  # noqa: E501

        :param mig_ndevices: The mig_ndevices of this DevicePoolModel.  # noqa: E501
        :type: int
        """

        self._mig_ndevices = mig_ndevices
