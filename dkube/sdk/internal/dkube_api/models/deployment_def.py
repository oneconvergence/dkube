...
class DeploymentDef(object):
    ...
    swagger_types = {
        ...
        'created_at': 'str',
        'updated_at': 'str',
        'inferenceservice_deployment': 'InferenceJobModel',
    ...
    def __init__(self, id=None, name=None, description=None, tags=None, owner=None, created_at=None, updated_at=None, inferenceservice_deployment=None, imported_deployment=None, modelmonitor=None):  # noqa: E501
