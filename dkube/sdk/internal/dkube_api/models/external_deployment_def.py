...
class ExternalDeploymentDef(object):
    ...
    def __init__(self, namespace=None, variant=None, cluster=None, reference_model=None, model=None, version=None, deployment_url=None, status=None, remote_deployment_id=None):  # noqa: E501
        ...
        self._status = None
        self._remote_deployment_id = None
        ...
        if status is not None:
            self.status = status
        if remote_deployment_id is not None:
            self.remote_deployment_id = remote_deployment_id
    ...
    @property
    def model(self):
        """Gets the model of this ExternalDeploymentDef.  # noqa: E501


        :return: The model of this ExternalDeploymentDef.  # noqa: E501
        :rtype: str
        """
        return self._model
    ...
    def model(self, model):
        """Sets the model of this ExternalDeploymentDef.


        :param model: The model of this ExternalDeploymentDef.  # noqa: E501
        :type: str
        """
    ...
    @property
    def version(self):
        """Gets the version of this ExternalDeploymentDef.  # noqa: E501


        :return: The version of this ExternalDeploymentDef.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this ExternalDeploymentDef.


        :param version: The version of this ExternalDeploymentDef.  # noqa: E501
        :type: str
        """
    ...
    @property
    def remote_deployment_id(self):
        """Gets the remote_deployment_id of this ExternalDeploymentDef.  # noqa: E501


        :return: The remote_deployment_id of this ExternalDeploymentDef.  # noqa: E501
        :rtype: str
        """
        return self._remote_deployment_id

    @remote_deployment_id.setter
    def remote_deployment_id(self, remote_deployment_id):
        """Sets the remote_deployment_id of this ExternalDeploymentDef.


        :param remote_deployment_id: The remote_deployment_id of this ExternalDeploymentDef.  # noqa: E501
        :type: str
        """

        self._remote_deployment_id = remote_deployment_id
