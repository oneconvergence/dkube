...
class AuthModel(object):
    ...
    swagger_types = {
        ...
        'pingfederate': 'AuthModelPingfederate',
        'okta_oidc': 'AuthModelOktaoidc',
    ...
    def __init__(self, mode=None, code=None, providers=None, saml=None, ldap=None, github=None, keycloak=None, pingfederate=None, okta_oidc=None, local=None):  # noqa: E501
        ...
        self._github = None
        self._keycloak = None
        self._pingfederate = None
        self._okta_oidc = None
        self._local = None
        ...
        if pingfederate is not None:
            self.pingfederate = pingfederate
        if okta_oidc is not None:
            self.okta_oidc = okta_oidc
    ...
    def mode(self, mode):
        ...
        allowed_values = ["github", "local", "saml", "ldap", "keycloak", "pingfederate", "okta-oidc"]  # noqa: E501
    ...
    @property
    def saml(self):
        """Gets the saml of this AuthModel.  # noqa: E501


        :return: The saml of this AuthModel.  # noqa: E501
        :rtype: AuthModelSaml
        """
        return self._saml
    ...
    @saml.setter
    def saml(self, saml):
        """Sets the saml of this AuthModel.


        :param saml: The saml of this AuthModel.  # noqa: E501
        :type: AuthModelSaml
        """
    ...
    @property
    def pingfederate(self):
        """Gets the pingfederate of this AuthModel.  # noqa: E501


        :return: The pingfederate of this AuthModel.  # noqa: E501
        :rtype: AuthModelPingfederate
        """
        return self._pingfederate

    @pingfederate.setter
    def pingfederate(self, pingfederate):
        """Sets the pingfederate of this AuthModel.


        :param pingfederate: The pingfederate of this AuthModel.  # noqa: E501
        :type: AuthModelPingfederate
        """

        self._pingfederate = pingfederate

    @property
    def okta_oidc(self):
        """Gets the okta_oidc of this AuthModel.  # noqa: E501


        :return: The okta_oidc of this AuthModel.  # noqa: E501
        :rtype: AuthModelOktaoidc
        """
        return self._okta_oidc

    @okta_oidc.setter
    def okta_oidc(self, okta_oidc):
        """Sets the okta_oidc of this AuthModel.


        :param okta_oidc: The okta_oidc of this AuthModel.  # noqa: E501
        :type: AuthModelOktaoidc
        """

        self._okta_oidc = okta_oidc
