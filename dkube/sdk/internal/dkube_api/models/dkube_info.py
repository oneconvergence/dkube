...
class DkubeInfo(object):
    ...
    def __init__(self, version=None, platform=None, itservices=None, cicd=None, license=None, release=None, auth=None, rdma=False, frameworks=None, features=None, features_disabled=None, tensorflow=None, minimal=False, registries=None):  # noqa: E501
