...
class ModelCatalogItemVersion(object):
    ...
    def __init__(self, version=None, name=None, publisher=None, owner=None, model=None, serving=None, training=None, description=None, published_timestamp=None):  # noqa: E501
