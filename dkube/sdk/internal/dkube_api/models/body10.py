...
class Body10(object):
    ...
    @property
    def users(self):
        """Gets the users of this Body10.  # noqa: E501

        Name of the valid users. Each  user should be a valid github user.  # noqa: E501

        :return: The users of this Body10.  # noqa: E501
        :rtype: list[str]
        """
        return self._users
    ...
    def users(self, users):
        """Sets the users of this Body10.

        Name of the valid users. Each  user should be a valid github user.  # noqa: E501

        :param users: The users of this Body10.  # noqa: E501
        :type: list[str]
        """
        if users is None:
