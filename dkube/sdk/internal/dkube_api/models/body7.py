...
class Body7(object):
    ...
    @property
    def users(self):
        """Gets the users of this Body7.  # noqa: E501

        Name of the valid users. Each  user should be a valid github user.  # noqa: E501

        :return: The users of this Body7.  # noqa: E501
        :rtype: list[str]
        """
        return self._users
    ...
    def users(self, users):
        """Sets the users of this Body7.

        Name of the valid users. Each  user should be a valid github user.  # noqa: E501

        :param users: The users of this Body7.  # noqa: E501
        :type: list[str]
        """
        if users is None:
    ...
    def group(self, group):
        """Sets the group of this Body7.

        Name of the valid group. This should be a valid group existing in dkube.  # noqa: E501

        :param group: The group of this Body7.  # noqa: E501
        :type: str
        """
