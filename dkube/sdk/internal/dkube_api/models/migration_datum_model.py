...
class MigrationDatumModel(object):
    ...
    def __init__(self, uuid=None, bucket=None, datum_type=None, details=None, dkube_datum_uui_ds=None, duplicate=None, duplicate_ref=None, migration_job_uuid=None, migration_uuid=None, progress=None, remote_uuid=None, status=None):  # noqa: E501
