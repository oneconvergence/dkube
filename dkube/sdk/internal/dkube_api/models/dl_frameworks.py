...
class DLFrameworks(object):
    ...
    def __init__(self, nb_ide=None, r_ide=None, vs_ide=None, training=None, preprocessing=None, eval=None, serving=None, project=None, frameworks=None, images=None):  # noqa: E501
