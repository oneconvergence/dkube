...
class FeatureSetVersionDef(object):
    ...
    def __init__(self, commit_id=None, created_ts=None, description=None, featureset_name=None, featureset_uuid=None, index=None, job=None, name=None, state=None, tags=None, tracking_uuid=None, updated_ts=None, user=None, uuid=None):  # noqa: E501
