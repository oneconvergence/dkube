...
class DriftMonitoringDef(object):
    ...
    def __init__(self, enabled=None, frequency=None, hard_threshold=None, image_train_data_savedfile_format=None, image_predict_data_savedfile_format=None, algorithm=None):  # noqa: E501
