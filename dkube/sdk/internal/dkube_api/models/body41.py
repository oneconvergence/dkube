...
class Body41(object):
    ...
    @property
    def jobs(self):
        """Gets the jobs of this Body41.  # noqa: E501

        List of jobs to archive/un-archive  # noqa: E501

        :return: The jobs of this Body41.  # noqa: E501
        :rtype: list[str]
        """
        return self._jobs
    ...
    @jobs.setter
    def jobs(self, jobs):
        """Sets the jobs of this Body41.

        List of jobs to archive/un-archive  # noqa: E501

        :param jobs: The jobs of this Body41.  # noqa: E501
        :type: list[str]
        """
        if jobs is None:
