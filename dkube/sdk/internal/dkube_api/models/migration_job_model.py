...
class MigrationJobModel(object):
    ...
    def __init__(self, uuid=None, _class=None, datums=None, details=None, dkube_job_uuids=None, migration_uuid=None, name=None, progress=None, remote_uuid=None, src_state=None, status=None):  # noqa: E501
