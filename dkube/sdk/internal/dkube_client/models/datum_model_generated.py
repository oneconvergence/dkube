...
class DatumModelGenerated(object):
    ...
    def __init__(self, head_version_index=None, head_version=None, updated_time=None, storage_path=None, affinity=None, uuid=None, status=None, size=None, progress=None, timestamps=None, tbref=None, user=None, details=None):  # noqa: E501
